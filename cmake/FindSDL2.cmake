...
get_filename_component(SDL2_LINK_DIRECTORY ${SDL2_LIBRARY} DIRECTORY)
get_filename_component(SDL2MAIN_LINK_DIRECTORY ${SDL2MAIN_LIBRARY} DIRECTORY)

mark_as_advanced(SDL2_LIBRARIES SDL2_INCLUDE_DIRS SDL2MAIN_LIBRARY SDL2_LIBRARY
  SDL2_INCLUDE_DIR)
...
if (SDL2_FOUND AND NOT TARGET sdl2)
  ...
  set_target_properties(sdl2 PROPERTIES
    ...
    INTERFACE_LINK_DIRECTORIES "${SDL2_LINK_DIRECTORY}"
    INTERFACE_INCLUDE_DIRECTORIES "${SDL2_INCLUDE_DIRS}")
  add_library(SDL2::SDL2 ALIAS sdl2)
endif()

if (SDL2_FOUND AND NOT TARGET sdl2main)
  add_library(sdl2main UNKNOWN IMPORTED)
  set_target_properties(sdl2main PROPERTIES
    IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    IMPORTED_LOCATION "${SDL2MAIN_LIBRARY}"
    INTERFACE_LINK_LIBRARIES "${SDL2MAIN_LIBRARY}"
    INTERFACE_LINK_DIRECTORIES "${SDL2MAIN_LINK_DIRECTORY}"
    INTERFACE_INCLUDE_DIRECTORIES "${SDL2_INCLUDE_DIRS}")
