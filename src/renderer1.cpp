...
createSwapchain(IDXGIFactory4* factory,
                ...
                IDXGIOutput* output = nullptr)
{
    ...
    HRESULT hr =
        factory->CreateSwapChainForHwnd(queue, GetActiveWindow(), swapchainDesc,
                                        fullscreenDesc, output, &swapchain);
...
void Renderer::initializeAPI(SDL_Window *window)
{
...
void Renderer::setupSwapchain(unsigned width, unsigned height)
{
    ...
    else
    {
        ...
        IDXGISwapChain1* swapchain = createSwapchain(
            mFactory, mCommandQueue, &swapchainDesc);
